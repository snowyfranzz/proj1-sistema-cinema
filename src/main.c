        ...
        if (desligado != 1) {
            ...
            do {
                ...
                for(i = 0; i < FILEIRAS; i++){
                    somaFileira = 0;
                    for(j = 0; j < ASSENTOS; j++){
                        somaFileira += (cinema[i][j] + matrizTemp[i][j]);
                    }
                ...
                for (i = 0; i < FILEIRAS; i++) {
                    ...
                    for (j = 0; j < ASSENTOS; j++) {
                        somaFileiraComp += (cinema[i][j] + matrizTemp[i][j]);
                        criticaS += (cinema[i][j] + matrizTemp[i][j]);

                        printf("%d ", cinema[i][j] + matrizTemp[i][j]);
                        if (j + 1 == ASSENTOS) {
                ...
                somaFileiraComp = 0;
                    ...
                    switch(i) {
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            printf(" | Ocupação:           %5.1f%%|           |            |\n", (float)(assentosOcupados + ingressosEscolhidos) / (FILEIRAS * ASSENTOS) * 100);
                            break;
                        case 5:
                            ...
                            break;
                        case 6:
                            printf(" | Assentos Ocupados:    %3d |           |            |\n", assentosOcupados + ingressosEscolhidos);
                            break;
                        case 7:
                            if (dividir == 1 && menosIncomodo < 999) {
                                if (recomendEsquerdo[1] != recomendDireito[1]) {
                                    printf(" | Assentos Disponíveis: %3d | * %02d      | * %02d ao %02d |\n", assentosDisponiveis - ingressosEscolhidos, recomendFil[1], recomendEsquerdo[1], recomendDireito[1]);
                                } else {
                                    printf(" | Assentos Disponíveis: %3d | * %02d      | * %02d       |\n", assentosDisponiveis - ingressosEscolhidos, recomendFil[1], recomendEsquerdo[1]);
                                }
                            } else {
                                printf(" | Assentos Disponíveis: %3d |           |            |\n", assentosDisponiveis - ingressosEscolhidos);
                            }
                            break;
                        case 8:
                    ...
                    case 2:
                        ...
                        if(ingressosEscolhidos == 0){
                            ...
                            if(cancelaTotal > ingressosEscolhidos || cancelaTotal <= 0){
                                system("cls");
                                printf("Número inválido! Você pode cancelar de 1 até %d assentos.\n", ingressosEscolhidos);
                                system("pause");
                            } else {
                                ...
                                for(i = 0; i < cancelaTotal; i++){
                                    ...
                                    if(cinema[fileiraTemp][assentoTemp] == 0 && matrizTemp[fileiraTemp][assentoTemp] == 1 && fileiraTemp >= 0 && fileiraTemp < FILEIRAS && assentoTemp >= 0 && assentoTemp < ASSENTOS){
                                        ...
                                        printf("\n\tNão foi possível cancelar esse assento!\n\n");
                                        i--;
                                        system("pause");
                                    }
                                    printf("\n");
            ...
            } while (ingressosEscolhidos != ingressos[0] + 1 && cancelado != 1);
